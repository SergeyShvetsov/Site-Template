$(function () {
    ...
    newCatA.click(function (e) {
        ...
        var imgUrl = "<img src='/Images/ajax-loader.gif' height='50' />";
        var deleteUrl = "/admin/shop/DeleteCategory/";
        ...
        $.post(url, { catName: catName }, function (data) {
            ...
            if (response == "titletaken") {
                ...
                if (!$("table#pages").length) {
                    ...
                    toAppend.find("a.delete").attr("href", deleteUrl + data);
